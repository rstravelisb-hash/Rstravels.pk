...
export const Route = createFileRoute("/air-ticketing")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "best air ticketing agency Islamabad, cheap flights from Islamabad, domestic flights pakistan, international flight booking Pakistan, cheapest fare flight, cheap tickets to UK from Islamabad, USA flight booking ISB, airline reservation Islamabad Blue Area, last minute flights Pakistan, group flight booking Islamabad, student discount tickets Islamabad, business class deals ISB, Umrah flight booking Islamabad, cheap flights to Dubai from ISB, Toronto flight from Islamabad, PIA ticket agent Islamabad, Emirates ticket Islamabad, Qatar Airways booking Pakistan, Turkish Airlines Islamabad, flight booking near me Islamabad, travel agency Blue Area Islamabad, air ticket price Islamabad to London, Islamabad to Jeddah flight, rehman travels flight deals, best travel agent Pakistan 2026, RS Travel and Tours air ticketing" },
      ...
      <section className="container-px mx-auto max-w-7xl py-20">
        <div className="group relative overflow-hidden rounded-[3rem] border border-white/10 shadow-2xl">
          <img
            ...
            alt="IATA authorized airline ticketing and international flight reservations"
