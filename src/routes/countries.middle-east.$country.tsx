...
export const Route = createFileRoute("/countries/middle-east/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best middle east visa consultant islamabad, top middle east visa agent pakistan, middle east visa success rate pakistan, middle east visa from pakistan 2026, rs travel and tours middle east visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "RS Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Middle East"} Visa Consultant Islamabad — Pakistan's #1 | RS Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://www.rstravels.pk/countries/middle-east/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://www.rstravels.pk/countries/middle-east/${loaderData?.slug || ""}` },
    ],
  }),
...
function MiddleEastCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://www.rstravels.pk/countries/middle-east/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
