...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Terms of service, refund rules, and consular disclaimer for RS Travel and Tours Islamabad." },
      { property: "og:url", content: "https://rstravel.pk/terms" },
      ...
      { name: "twitter:title", content: "Terms & Conditions | RS Travel and Tours" },
      { name: "twitter:description", content: "Terms of service, refund rules, and consular disclaimer." },
      { name: "twitter:image", content: "https://rstravel.pk/og-image.jpg" },
    ],
    links: [{ rel: "canonical", href: "https://rstravel.pk/terms" }],
  }),
  component: TermsPage,
});
