  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "rs travel and tours, rs travels pk, rs travel islamabad, rs travels blue area islamabad, rs travel visa consultant, rs travel and tours contact number, rs travels whatsapp number, rs travel umrah packages, rs travel air ticketing, rs travel and tours reviews, best visa consultant in islamabad, top travel agency pakistan, #1 travel agency islamabad, visa processing services islamabad, visa documentation services pakistan, visa file preparation islamabad, uk visa consultant islamabad, usa visa help pakistan, schengen visa agent blue area, canada visit visa help, australia visa pakistan, iata travel agent islamabad, best umrah packages 2026, cheap flights pakistan, flight booking pakistan, hotel reservation islamabad, domestic flights pakistan, international flight tickets, ramzan umrah packages, executive umrah packages, 15 days umrah packages from pakistan, umrah e visa from pakistan, dubai visit visa, turkey visit visa, malaysia visit visa, thailand visit visa, azerbaijan visit visa, travel insurance pakistan, corporate travel agency pakistan, visa rejection help islamabad, visa refusal appeal pakistan, best travel agency islamabad pakistan",
      },
    ...
    links: [
      ...
      { rel: "alternate", hrefLang: "en-PK", href: "https://rstravel.pk/" },
      { rel: "alternate", hrefLang: "en", href: "https://rstravel.pk/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://rstravel.pk/" },
    ],
  }),
  component: Home,
});
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {[
                ...
                },
                {
                  icon: Award,
                  t: "Fast Processing",
                  d: "Direct portal submissions with prioritized consular processing queues.",
