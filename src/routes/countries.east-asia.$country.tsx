...
export const Route = createFileRoute("/countries/east-asia/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best east asia visa consultant islamabad, top east asia visa agent pakistan, east asia visa success rate pakistan, east asia visa from pakistan 2026, rs travel and tours east asia visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "RS Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "East Asia"} Visa Consultant Islamabad — Pakistan's #1 | RS Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://www.rstravels.pk/countries/east-asia/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://www.rstravels.pk/countries/east-asia/${loaderData?.slug || ""}` },
    ],
  }),
...
function EastAsiaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://www.rstravels.pk/countries/east-asia/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
