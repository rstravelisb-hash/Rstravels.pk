...
export const Route = createFileRoute("/countries/south-america/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://rstravel.pk/countries/south-america/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://rstravel.pk/countries/south-america/${loaderData?.slug || ""}` },
    ],
  }),
...
function SouthAmericaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://rstravel.pk/countries/south-america/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
