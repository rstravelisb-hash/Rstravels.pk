...
export const Route = createFileRoute("/countries/south-asia/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://www.rstravels.pk/countries/south-asia/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://www.rstravels.pk/countries/south-asia/${loaderData?.slug || ""}` },
    ],
  }),
...
function SouthAsiaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://www.rstravels.pk/countries/south-asia/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
