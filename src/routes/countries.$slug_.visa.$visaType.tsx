...
export const Route = createFileRoute("/countries/$slug_/visa/$visaType")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: loaderData?.visa.seoTitle || "Visa Consultant Islamabad | RS Travel and Tours" },
      ...
      { property: "og:url", content: `https://rstravel.pk/countries/${loaderData?.destination.slug}/visa/${loaderData?.visa.slug}` },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "en_PK" },
      { property: "og:site_name", content: "RS Travel and Tours — Pakistan's No.1 Travel Agency" },
      { property: "og:image", content: loaderData?.destination.image || "https://rstravel.pk/og-image.jpg" },
      ...
      { name: "twitter:image", content: loaderData?.destination.image || "https://rstravel.pk/og-image.jpg" },
    ],
    links: [
      { rel: "canonical", href: `https://rstravel.pk/countries/${loaderData?.destination.slug}/visa/${loaderData?.visa.slug}` },
    ],
  }),
...
function VisaSubPage() {
  ...
  const subVisaSchema = {
    ...
    "@type": "Service",
    "@id": `https://rstravel.pk/countries/${destination.slug}/visa/${visa.slug}#service`,
