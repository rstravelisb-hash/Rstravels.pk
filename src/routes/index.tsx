...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.rstravels.pk/" },
      ...
      { name: "twitter:image", content: "https://www.rstravels.pk/src/assets/hero-travel.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://www.rstravels.pk/" },
      { rel: "alternate", hrefLang: "en-PK", href: "https://www.rstravels.pk/" },
      { rel: "alternate", hrefLang: "en", href: "https://www.rstravels.pk/" },
      { rel: "alternate", hrefLang: "x-default", href: "https://www.rstravels.pk/" },
    ],
  }),
  component: Home,
});
