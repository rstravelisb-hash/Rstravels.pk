      ...
      <div className="container-px mx-auto max-w-7xl py-20 relative">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="flex items-center gap-4 group cursor-default">
              <div className="relative">
                <img src={logo} alt="" className="h-12 w-auto brightness-0 invert group-hover:scale-110 transition-transform duration-500" />
          ...
          <div className="lg:col-span-2">
            <h3 className="text-xs font-bold text-white uppercase tracking-[0.2em] mb-8">Destinations</h3>
          ...
          {/* Quick Links */}
          <div className="lg:col-span-2">
            <h3 className="text-xs font-bold text-white uppercase tracking-[0.2em] mb-8">Explore</h3>
            <ul className="space-y-4">
              {[
          ...
          <div className="lg:col-span-4 space-y-8">
            <h3 className="text-xs font-bold text-white uppercase tracking-[0.2em]">Get in Touch</h3>
        ...
        <div className="mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-white/40">
            ...
            <div className="h-3 w-px bg-white/10 hidden sm:block" />
            <span className="text-[10px] font-bold text-white/20 uppercase tracking-[0.3em]">Blue Area Islamabad</span>
          </div>
        </div>
      </div>
    </footer>
