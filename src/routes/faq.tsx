...
export const Route = createFileRoute("/faq")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://rstravel.pk/faq" },
      ...
      { name: "twitter:title", content: "FAQ — RS Travel and Tours Islamabad" },
      { name: "twitter:description", content: "Frequently asked questions regarding visas, Umrah packages, flight tickets and hotel bookings." },
      { name: "twitter:image", content: "https://rstravel.pk/og-image.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://rstravel.pk/faq" },
    ],
  }),
  component: FAQPage,
});
          ...
          <div className="rounded-[3rem] border border-border/50 bg-card/30 backdrop-blur-xl p-6 md:p-12 shadow-2xl relative overflow-hidden transition-all duration-500 hover:border-primary/30">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-10">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-primary-glow text-primary-foreground shadow-md">
                  <HelpCircle size={24} />
                </div>
