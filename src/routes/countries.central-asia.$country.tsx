...
export const Route = createFileRoute("/countries/central-asia/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://rstravels.pk/countries/central-asia/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://rstravels.pk/countries/central-asia/${loaderData?.slug || ""}` },
    ],
  }),
...
function CentralAsiaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://rstravels.pk/countries/central-asia/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
