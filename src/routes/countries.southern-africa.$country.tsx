...
export const Route = createFileRoute("/countries/southern-africa/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://rstravels.pk/countries/southern-africa/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://rstravels.pk/countries/southern-africa/${loaderData?.slug || ""}` },
    ],
  }),
