...
export const Route = createFileRoute("/countries/$slug_/visa/$visaType")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { property: "og:url", content: `https://rstravels.pk/countries/${loaderData?.destination.slug}/visa/${loaderData?.visa.slug}` },
...
function VisaSubPage() {
  ...
  const subVisaSchema = {
    ...
    "@type": "Service",
    "@id": `https://rstravels.pk/countries/${destination.slug}/visa/${visa.slug}#service`,
