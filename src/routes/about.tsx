...
function About() {
  const aboutSchema = {
    ...
    "@type": "AboutPage",
    "@id": "https://rstravels.pk/about#webpage",
    "url": "https://rstravels.pk/about",
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                d: "Founded with a commitment to integrity and client success, now Islamabad's premier consultancy.",
              },
            ].map((b, i) => (
            ...
            <Reveal>
              <div className="relative rounded-[3rem] overflow-hidden border border-border shadow-2xl">
                <img
                  ...
                  alt="RS Travel and Tours worldwide flight departures and aviation services"
