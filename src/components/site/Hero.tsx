        ...
        >
          <div className="mb-6 text-center px-4">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
              <Link
                to="/consultation"
                className="inline-flex items-center gap-2 rounded-full bg-accent px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-bold text-accent-foreground shadow-glow hover:shadow-elevated transition-all hover:-translate-y-0.5"
              >
                Book Free Consultation
              </Link>
              <Link
                to="/profile-assessment"
                className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 backdrop-blur-md px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-bold text-white hover:bg-white/20 transition-all hover:-translate-y-0.5"
              >
                <FileText size={14} /> Free Visa Assessment
              </Link>
              <a
                href="https://wa.me/923445979486?text=Hi%20RS%20Travels,%20I%20need%20visa%20and%20ticket%20assistance"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/20 backdrop-blur-md px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-bold text-emerald-300 hover:bg-emerald-500/30 transition-all hover:-translate-y-0.5"
              >
                WhatsApp Us
              </a>
            </div>
          </div>
          <Suspense fallback={<div className="min-h-[380px] sm:min-h-[320px] lg:min-h-[280px] w-full animate-pulse rounded-[2rem] sm:rounded-[2.5rem] bg-white/10 backdrop-blur-2xl border border-white/20" />}>
            <BookingWidget />
          </Suspense>
        </motion.div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-8">
          ...
          >
            <span className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-white/90 backdrop-blur">
              <ShieldCheck size={13} className="text-accent-glow" /> Pakistan&apos;s Trusted Visa
