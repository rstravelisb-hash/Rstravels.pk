...
export const Route = createFileRoute("/travel-insurance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://rstravel.pk/travel-insurance" },
      ...
      { name: "twitter:description", content: "Instant Schengen-compliant travel insurance. Official partners of top insurers in Pakistan." },
      { name: "twitter:image", content: "https://rstravel.pk/og-image.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://rstravel.pk/travel-insurance" },
    ],
  }),
...
function TravelInsurance() {
  const insuranceSchema = {
    ...
    "@type": "Service",
    "@id": "https://rstravel.pk/travel-insurance#service",
