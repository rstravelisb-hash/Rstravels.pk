...
export const Route = createFileRoute("/countries/central-asia/$country")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "keywords", content: `${loaderData?.keywords || ""}, best central asia visa consultant islamabad, top central asia visa agent pakistan, central asia visa success rate pakistan, central asia visa from pakistan 2026, rs travel and tours central asia visa, blue area visa consultant` },
      { name: "robots", content: "index, follow, max-snippet:-1, max-image-preview:large" },
      { name: "author", content: "RS Travel and Tours" },
      { name: "geo.region", content: "PK-IS" },
      { name: "geo.placename", content: "Islamabad" },
      { property: "og:title", content: `${loaderData?.name || "Central Asia"} Visa Consultant Islamabad — Pakistan's #1 | RS Travel and Tours` },
      { property: "og:description", content: loaderData?.description || "" },
      { property: "og:url", content: `https://www.rstravels.pk/countries/central-asia/${loaderData?.slug || ""}` },
    ...
    links: [
      { rel: "canonical", href: `https://www.rstravels.pk/countries/central-asia/${loaderData?.slug || ""}` },
    ],
  }),
...
function CentralAsiaCountryPage() {
  ...
  const jsonLd = {
    ...
    url: `https://www.rstravels.pk/countries/central-asia/${country.slug}`,
    provider: {
      "@type": "TravelAgency",
