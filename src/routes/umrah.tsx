...
function UmrahPage() {
  const umrahSchema = {
    ...
    "@graph": [
      {
        "@type": "TouristTrip",
        "@id": "https://rstravel.pk/umrah#trip",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://rstravel.pk/umrah#faq",
        "mainEntity": [
          {
            "@type": "Question",
          ...
          <div className="grid gap-12 lg:grid-cols-2 items-center">
            <Reveal>
              <div className="space-y-6">
                <div className="inline-flex items-center gap-2 rounded-full bg-primary/20 border border-primary/30 px-4 py-1.5 text-xs font-bold text-primary mb-6 shadow-sm">
                  Tailor-Made For You
                </div>
              ...
              <div className="relative group">
                ...
                <div className="relative aspect-[4/5] rounded-[3rem] overflow-hidden shadow-2xl isolate transform translate-z-0 border border-white/10">
                  <img
                    ...
                    alt="Pilgrims performing Umrah in Makkah with RS Travel and Tours packages"
